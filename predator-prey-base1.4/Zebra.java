...
public class Zebra extends Animal {
     ...
     */
    public Zebra(boolean randomAge, Field field, Location location, Color col, String geneString) {
    ...
    private void giveBirth(List<Animal> newZebras) {
        ...
        for(int b = 0; b < births && free.size() > 0; b++) {
            ...
            if (mate != null) {
                ...
                Zebra young = new Zebra(false, field, loc, getColor(), offspringGene);
                newZebras.add(young);
            }
        }
    }
