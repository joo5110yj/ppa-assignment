 ...
 * Hyenas age, move, eat rabbits, and die.
 * 
...
public class Hyena extends Animal {
     ...
     */
    public Hyena(boolean randomAge, Field field, Location location, Color col) {
    ...
    private void giveBirth(List<Animal> newHyenas) {
        ...
        for(int b = 0; b < births && free.size() > 0; b++) {
            ...
            Hyena young = new Hyena(false, field, loc, getColor());
            newHyenas.add(young);
        }
    }
